          ...
          <DropdownMenu >
            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <div className="max-h-80 overflow-y-auto">
                <DropdownMenuItem className="py-3 cursor-pointer bg-white">
                  <div>
                    <p className="font-medium">Quán mới đăng ký</p>
                    <p className="text-sm text-gray-500">Cafe Ngon đã đăng ký và đang chờ duyệt</p>
                ...
                <DropdownMenuItem className="py-3 cursor-pointer">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Người dùng báo cáo nội dung không phù hợp tại Cafe ABC</p>
