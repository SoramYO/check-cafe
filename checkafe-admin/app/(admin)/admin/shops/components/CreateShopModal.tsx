...
import { MapPin, Phone, Globe, User, Coffee, Clock, RefreshCw, Plus, Edit } from "lucide-react"
...
export function CreateShopModal({ open, onClose, onSuccess }: CreateShopModalProps) {
